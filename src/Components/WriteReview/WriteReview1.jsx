        ...
        <div className="review-content">
          ...
          <div className="row">
            <div className="sharing">
              ...
              <p className="title">Including you, how many people are living in this property?</p>
          ...
          <div className="row">
            <div className="buttons">
              <button className="pre-step" disabled>Previous step</button>
              <button className="next-step" onClick={()=>{ window.location.href = 'write-a-review-2';}}>Next step</button>
            </div>
          </div>
        </div>
      </div>
